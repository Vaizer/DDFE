...
Included sketch mainly aims pre-facelift models (-2004), but all accumulated informartion about other MY are included in sketch for you to try!\
...
Pre-facelift cars (-2004) would need getting second OBD2 (or any other) connector **WITH** CAN-L and CAN-H from CEM or it will not work!\
Facelift cars already have CANs on OBD2. Instructions for connecting second OBD2 and device assebly are also included.  \
...
Also check Volvo-P2-informer by drPioneer, inspired by my project: https://github.com/drpioneer/Volvo-P2-informer </br> Same hardware, sketch for facelift models (XC90 2011)
